...
void SDL::Rectangle(int x, int y, int w, int h, u32 scolor, Renderer rend) {
    SDL_Rect pos;
    pos.x = x;
    pos.y = y;
    pos.w = w;
...
void SDL::Texture(std::string tex, u32 x, u32 y, Renderer rend) {
...
void SDL::Text(TTF_Font *font, Renderer rend, int x, int y, std::string str) {
    SDL_Color scolor;
