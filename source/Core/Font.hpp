...
class Cache {
    public:
        ...
        void drawWord(SDL_Renderer* renderer, Context& context, char*& ptr, const char* end, u8 fontIndex);
        u64 sizeWord(SDL_Renderer* renderer, Context& context, char* ptr, const char* end);
...
class Fonts {
    public:
        ...
        void draw(SDL_Renderer* renderer, int x, int y, const std::string& s, const Context& settings)
        {
            ...
            {
                auto& cache = fontCache(settings);
                cache.draw(renderer, x, y, s, settings.fontIndex);
            }
        }

        void draw(SDL_Renderer* renderer, const SDL_Rect& rect, const std::string& s, const Context& settings, Align align = Align::LEFT)
        {
            SDL_Rect r = rect;
...

            {
                ...
                cache.draw(renderer, r, s, settings.fontIndex);
            }
        }
